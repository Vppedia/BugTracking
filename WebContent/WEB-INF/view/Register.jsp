...
.
      ...
      <div class="panel-body" >
          <form class="form-horizontal form-signin" action=" insertIntoDB" method="post" onsubmit="return validate()"> 
	      ...
	      <b>EmailId</b><sup>*</sup><input type="email" class="form-control" id="email" name="email" placeholder="EMAIL" required autofocus/><br>
	        ...
	        <b>Field</b><sup>*</sup>
	      <select class="form-control" name="field" id="#" required>
							<option value="0">Select Your Designation</option>
							<option value="developer">Developer</option>
							<option value="bt">Buggtracking</option>
							
							<option value="vt">vechiletracking</option>
          </select> <br>
	  
	      
	        <b>Password</b><sup>*</sup><input type="password" class="form-control" id="pwd" name="password" placeholder="PASSWORD" required autofocus/>
	         	      
	      <b>Confirm Password</b><sup>*</sup><input type="password" class="form-control" id="cpwd" name="confirmpassword" placeholder="RE-ENTER PASSWORD" required autofocus/>
...
function validate()
{
	 ...
	 if(pwd==cpwd)
		 ...
		 {
		 document.getElementById("message").innerHTML="Password Doesn'nt match";
		 return false;
